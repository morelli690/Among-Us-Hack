...
struct Runtime {
	...
	{
		auto il2cpp_class_from_index = (il2cpp_class_from_index_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_image_get_class");

		return il2cpp_class_from_index(assembly, index);
	}
	static uint32_t il2cpp_method_get_token(Il2CppMethod* method)
	{
		auto il2cpp_method_get_token = (il2cpp_method_get_token_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_method_get_token");
	...
	{
		auto il2cpp_class_get_fields = (il2cpp_class_get_fields_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_class_get_fields");
	...
	{
		auto il2cpp_class_get_methods = (il2cpp_class_get_methods_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_class_get_methods");
	...
	{
		auto il2cpp_field_from_name = (il2cpp_class_get_field_from_name_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_class_get_field_from_name");
	...
	static Il2CppMethod* il2cpp_property_get_get_method(Il2CppClass* klass, const char* name) {
		il2cpp_class_get_property_from_name_t il2cpp_string_chars = (il2cpp_class_get_property_from_name_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_class_get_property_from_name");
		il2cpp_property_get_get_method_t il2cpp_string_chars_2 = (il2cpp_property_get_get_method_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_property_get_get_method");
	...
	{
		auto il2cpp_field_get_value = (il2cpp_field_get_value_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_field_get_value");
	...
	{
		auto il2cpp_field_set_value = (il2cpp_field_set_value_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_field_set_value");

		return il2cpp_field_set_value(object, field, value);
	}
	static void il2cpp_field_static_get_value(Il2CppField* field, void* value)
	{
		auto il2cpp_field_static_get_value = (il2cpp_field_static_get_value_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_field_static_get_value");

		return il2cpp_field_static_get_value(field, value);
	}
	static void il2cpp_field_static_set_value(Il2CppField* field, void* value)
	{
		auto il2cpp_field_static_set_value = (il2cpp_field_static_set_value_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_field_static_set_value");
	...
	{
		auto il2cpp_string_chars = (il2cpp_string_chars_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_string_chars");

		return il2cpp_string_chars(string);
	}
	static uint32_t il2cpp_object_get_size(Il2CppObject* object)
	{
		auto il2cpp_object_get_size = (il2cpp_object_get_size_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_object_get_size");

		return il2cpp_object_get_size(object);
	}
	static uint32_t il2cpp_array_get_byte_length(Il2CppArray* array)
	{
		auto il2cpp_array_get_byte_length = (il2cpp_array_get_byte_length_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_array_get_byte_length");

		return il2cpp_array_get_byte_length(array);
	}
	static uint32_t il2cpp_array_get_length(Il2CppArray* array)
	{
		auto il2cpp_array_get_length = (il2cpp_array_get_length_t)GetProcAddress(GetIL2CPPModule(), "il2cpp_array_length");

		return il2cpp_array_get_length(array);
	}
	template <typename T>
	static inline T GetMethod(DWORD64 Offset)
	{
		return (T)((uint8_t*)GetIL2CPPModule() + Offset);
	}
	template <typename T>
	static inline T GetField(void* obj, std::ptrdiff_t Offset)
	{
		return *(T*)((std::uint8_t*)obj + Offset);
	}
	template <typename T>
	static void SetField(void* obj, std::ptrdiff_t Offset, T val)
	{
		*(T*)((std::uint8_t*)obj + Offset) = val;
	}
	static std::string utf16_to_utf8(const char16_t* str)
	{
		std::size_t size = 0;
		while (str[size])
			++size;
	...
	static std::string GetString(Il2CppString* string)
	{
		return utf16_to_utf8(il2cpp_string_chars(string));
	}
};